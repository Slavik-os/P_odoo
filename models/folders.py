...
class FolderManagment(models.Model):
    ...
    def write(self, vals):
        for folder in self :
            if folder.folder_type != 'difinitive':
                super(FolderManagment, folder).write(vals)
                return
        raise ValidationError(_("Cant edit"))

    # Dum
    _n_dum = fields.Many2one('dum.number', string="N °Dum",tracking=True)
    n_dum  = fields.Selection(related="_n_dum.ndum",copy=True,store=True,readonly=False,tracking=True)
    ...
    destinataire = fields.Selection(related="_expiditeur.expiditeur_ids",
                                  string="Déstinataire",copy=True,store=True,readonly=False,tracking=True)
    ...
    bureax_dedouane = fields.Selection(related='_bureax_dedouane.bureaux_dedouan',
                                       string='Bureau de dédouanement',copy=True,store=True,readonly=False,tracking=True)
    ...
    bureaux_destinataire = fields.Selection(related='_bureax_dedouane.burea_destinataire',
                                            copy=True,store=True,readonly=False ,tracking=True)
    ...
    mode_transport = fields.Selection(related='_mode_transport.mode_transport',copy=True,store=True,readonly=False,tracking=True)
    ...
    compagine = fields.Selection(related="_compagine.compagine_list",
                                 copy=True,store=True,string="Compagine",readonly=False,tracking=True)
    ...
    transitaire = fields.Selection(related="_transitaire.transitaire",
                                   copy=True,store=True,string="Transitaire",readonly=False,tracking=True)
    #Ref transitaire
    ...
    #Expiditeur
    expiditeur = fields.Selection(related="_expiditeur.expiditeur_ids",
                                   copy=True,store=True,readonly=False, tracking=True)
